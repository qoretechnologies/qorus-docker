...
- `public.ecr.aws/qorus/qorus-ce:latest` (Ubuntu 24.04 LTS, Java 17, Python 3.11, Oracle Instant Client 21.1)
- `public.ecr.aws/qorus/qorus-ce-alpine:latest` (Alpine Linux 3.21, Java 17, Python 3.11, Oracle Instant Client 21.1)
- `public.ecr.aws/qorus/qorus-ce-alpine-minimal:latest` (Alpine Linux 3.21, Python 3.11, without Java or Oracle client libraries)
